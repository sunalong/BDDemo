...
public class UDFMd5 extends UDF {
  ...
  public static void main (String[] args ) {
    UDFMd5 md5 = new UDFMd5();
    System.out.println(md5.evaluate(new Text(" ")));
    System.out.println("fuck:"+md5.evaluate(new Text("fuck")));
    System.out.println("fck2:"+md5.evaluate(new Text("fu2324ck")));
  }
}
